    ...
    <>
      <div className="myaccount-content">
        <div className="save_button mt-3 d-flex align-items-center justify-content-between">
          ...
          <Link to="/account-edit" className="theme-btn-one bg-black btn_sm">
            Güncelle
          </Link>
        </div>
        <div className="login_form_container">
          <div className="account_details_form">
            <form action="#">
              ...
              <span className="example">( 05/12/1970)</span>
              <br />
              ...
              >
                ...
                <p className="mt-2">
                  Herhangi bir zamanda abonelikten çıkabilirsiniz!
                </p>
              </label>
            </form>
          </div>
