          ...
          <div className="row">
            <div className="col-lg-4 col-md-12 col-sm-12 col-12">
              <div className="footer_left_side">
                ...
                <p>
                  <strong>BT SHOP</strong> çok satıcılı bir B2C hızlı e-ticaret
                  şirketidir. Şirket ağırlıklı olarak erkek, kadın ve çocuk
                  giyimine odaklanmaktadır. ama aynı zamanda başka giysiler,
                  giysiler, aksesuarlar, ayakkabılar, çantalar ve diğer moda
                  ürünleri de sunuyoruz.
                </p>
          ...
          <div className="row">
            <div className="col-lg-6 col-md-6 col-sm-6 col-12">
              <div className="copyright_left">
                <h6>
                  © CopyRight 2022 <span>Bt Shop</span>
                </h6>
              </div>
            </div>
            <div className="col-lg-6 col-md-6 col-sm-6 col-12">
